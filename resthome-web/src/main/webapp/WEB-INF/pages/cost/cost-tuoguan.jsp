			...
			$.messager.confirm("删除确认","你确定要删除选中的信息吗？",function(r){
				if(r){
					...
					for(var i=0;i<rows.length;i++){
						...
						var id = staff.tuoguanId;
						array.push(id);
					}
					var ids = array.join(",");//1,2,3,4,5
					location.href = "tuoguan/delete?ids="+ids;
				}
			});
		}
	}
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="添加接待信息" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="oldManForm" action="tuoguan/insert" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>托管金额</td>
						<td><input type="text" name="costBalance" class="easyui-numberbox" required="true"/>&nbsp&nbsp元</td>
					</tr>
