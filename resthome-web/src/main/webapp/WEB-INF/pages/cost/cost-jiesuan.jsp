			...
			$.messager.confirm("删除确认","你确定要删除选中的信息吗？",function(r){
				if(r){
					...
					for(var i=0;i<rows.length;i++){
						...
						var id = staff.costJiesuanId;
						array.push(id);
					}
					var ids = array.join(",");//1,2,3,4,5
					location.href = "jiesuan/delete?ids="+ids;
				}
			});
		}
	}
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 添加  -->
	<div class="easyui-window" title="添加费用结算信息" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="oldManForm" action="jiesuan/insert" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
						<td colspan="2">添加费用结算信息</td>
					</tr>
					...
					<tr>
						<td>是否结算</td>
						<td><select  name="jiesuanStatus" id="jiesuanStatus"  editable="false"   class="easyui-combobox" style="width: 145px;" >
					...
					<tr>
						<td>结算日期</td>
						<td><input type="text" name="jiesuanDate"  editable="false"  class="easyui-datebox" required="true" /></td>
					</tr>
					<tr>
						<td>操作人</td>
