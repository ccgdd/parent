...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn-out").click(function(){
			//将指定的form表单中所有的输入项转为json数据{key:value,key:value}
			var p = $("#searchForm").serializeJson2();
			console.info(p);
			//调用数据表格的load方法，重新发送一次ajax请求，并且提交参数
			$("#grid").datagrid("load",p);
			//关闭查询窗口
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="searchForm">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>期间入库统计:</td>
						<td> <input class="easyui-datebox" style="width: 125px" name="inDate" id="inDate"/> - <input class="easyui-datebox" style="width: 125px" name="inDate" id="inDate"/>
						</td>
						<td colspan="1"><a id="btn-in" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" plain="true"	>查询</a> </td>
					</tr>
					<tr>
						<td>期间出库统计:</td>
						<td> <input class="easyui-datebox" style="width: 125px" name="outDate" id="outDate"/> - <input class="easyui-datebox" style="width: 125px" name="outDate" id="outDate"/>
						</td>
						<td colspan="1"><a id="btn-out" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" plain="true"	>查询</a> </td>
