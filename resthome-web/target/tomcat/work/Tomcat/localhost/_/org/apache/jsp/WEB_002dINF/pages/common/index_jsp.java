 ...
 * Generated at: 2018-05-18 14:10:16 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>restHome</title>\r\n");
      ...
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/receptMenu.json',\r\n");
      out.write("\t\t\ttype : 'POST',\r\n");
      out.write("\t\t\tdataType : 'text',\r\n");
      out.write("\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\tvar zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("\t\t\t\t$.fn.zTree.init($(\"#receptMenu\"), setting, zNodes);\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror : function(msg) {\r\n");
      out.write("\t\t\t\talert('菜单加载异常!');\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/costMenu.json',\r\n");
      out.write("\t\t\ttype : 'POST',\r\n");
      out.write("\t\t\tdataType : 'text',\r\n");
      out.write("\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\tvar zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("\t\t\t\t$.fn.zTree.init($(\"#costMenu\"), setting, zNodes);\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror : function(msg) {\r\n");
      out.write("\t\t\t\talert('菜单加载异常!');\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/goodsMenu.json',\r\n");
      out.write("\t\t\ttype : 'POST',\r\n");
      out.write("\t\t\tdataType : 'text',\r\n");
      out.write("\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\tvar zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("\t\t\t\t$.fn.zTree.init($(\"#goodsMenu\"), setting, zNodes);\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror : function(msg) {\r\n");
      out.write("\t\t\t\talert('菜单加载异常!');\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/contentMenu.json',\r\n");
      out.write("\t\t\ttype : 'POST',\r\n");
      out.write("\t\t\tdataType : 'text',\r\n");
      out.write("\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\tvar zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("\t\t\t\t$.fn.zTree.init($(\"#contentMenu\"), setting, zNodes);\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror : function(msg) {\r\n");
      out.write("\t\t\t\talert('菜单加载异常!');\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/oldmanMenu.json',\r\n");
      out.write("\t\t\ttype : 'POST',\r\n");
      out.write("\t\t\tdataType : 'text',\r\n");
      out.write("\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\tvar zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("\t\t\t\t$.fn.zTree.init($(\"#oldmanMenu\"), setting, zNodes);\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror : function(msg) {\r\n");
      out.write("\t\t\t\talert('菜单加载异常!');\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\tlocation.href = '/loginout.action';\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t// 修改密码\r\n");
      ...
      out.write("\t\tstyle=\"height:80px;padding:10px;background:url('./images/header_bg.png') no-repeat right;background-size:100% 80px;\">\r\n");
      ...
      if (_jspx_meth_shiro_005fhasPermission_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t<div title=\"费用管理\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
      out.write("\t\t\t\t<ul id=\"costMenu\" class=\"ztree\"></ul>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div title=\"老人管理\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">  \r\n");
      out.write("\t\t\t\t<ul id=\"oldmanMenu\" class=\"ztree\"></ul>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t");
      if (_jspx_meth_shiro_005fhasPermission_005f1(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t<div title=\"\" data-options=\"iconCls:'icon-mini-add',selected:true\" style=\"overflow:auto\"> \r\n");
      out.write("\t\t\t\t<ul id=\"contentMenu\" class=\"ztree\"></ul>\r\n");
      out.write("         </div>\r\n");
      out.write("         \r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\tstyle=\"height:50px;padding:10px;background:url('./images/header_bg.png') no-repeat right; background-size:100% 80px;\">\r\n");
      out.write("\t\t<table style=\"width: 100%;\">\r\n");
      out.write("\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td style=\"width: 300px;\">\r\n");
      out.write("\t\t\t\t\t\t<div style=\"color: #999; font-size: 8pt;\">\r\n");
      out.write("\t\t\t\t\t\t\t桂电信科程国栋 | Powered by <a href=\"http://localhost:8088/\">com.cgd</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/pages/common/index.jsp(262,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f0.setName("user-function");
    int _jspx_eval_shiro_005fhasPermission_005f0 = _jspx_th_shiro_005fhasPermission_005f0.doStartTag();
    if (_jspx_eval_shiro_005fhasPermission_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t<div title=\"接待管理\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
        out.write("\t\t\t\t<ul id=\"receptMenu\" class=\"ztree\"></ul>\r\n");
        out.write("\t\t\t</div>\r\n");
        out.write("\t\t\t");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/pages/common/index.jsp(274,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f1.setName("user-function");
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t<div title=\"人事管理\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">  \r\n");
        out.write("\t\t\t\t<ul id=\"adminMenu\" class=\"ztree\"></ul>\r\n");
        out.write("\t\t\t</div>\r\n");
        out.write("\t\t\t<div title=\"仓库管理\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
        out.write("\t\t\t\t<ul id=\"goodsMenu\" class=\"ztree\"></ul>\r\n");
        out.write("\t\t\t</div>\r\n");
        out.write("\t\t\t\r\n");
        out.write("\t\t<div title=\"床位管理\" data-options=\"iconCls:'icon-mini-add',selected:true\" style=\"overflow:auto\"> \r\n");
        out.write("\t\t\t\t<ul id=\"contentMenu\" class=\"ztree\"></ul>\r\n");
        out.write("         </div>\r\n");
        out.write("         ");
